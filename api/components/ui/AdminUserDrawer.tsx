...
// Slide-in-from-the-right panel, modeled on the sibling up-excise-spatial-revenue-optimizer
// project's EditAdminUserDrawer — same "backdrop click / Escape / animate translate-x" shape,
// restyled to this app's plain Tailwind (no daisyUI) + Button/Banner components. Shared between
// create and edit (pass `user: null` for create), same as the sibling project, since the form
